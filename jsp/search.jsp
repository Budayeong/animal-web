...
<%@ include file="home1.jsp" %>
	...
	<%
	//검색된 데이터 가져오기
	ArrayList<InfoDo> aList = adao.getSearch(request.getParameter("searchField"), request.getParameter("searchText"));
	%>
		...
		<div class="card" style="width: 18rem; margin:auto;">
		  ...
		  <div class="card-body">
		    ...
		    <p class="card-text">
		    	...
		    	체중: <%= s.getWeight() %>
		    	<br>
		    	특징: <%= s.getCharacteristic() %>
		    	<br>
		    	발견장소: <%= s.getPlace() %>
		    </p>
		    <a href="addrInfo.jsp?num=<%=s.getNum()%>" class="btn btn-primary">더보기</a>
		  </div>
		</div>
    </div>
    <!-- card 1 END -->
